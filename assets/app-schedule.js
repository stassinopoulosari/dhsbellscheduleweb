...
(() => {
  ...
  var $scheduleTable = document.querySelector("#scheduleTable"),
    $template =
      '<li class="{{current}}"><div class="className">{{className}}</div><pre class="time">{{startTime}} — {{endTime}}</pre></li>';
    ...
    .then((bsData) => {
      ...
      if (!bsData.schedule) {
        $scheduleTable.innerHTML =
          '<li><div class="className">No schedule was found for today.</div></li>';
        return;
      }
